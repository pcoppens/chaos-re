...
public class EsbLogEntry {
    private String svId;
    private EndPointEntry endPointEntry;
    private ZonedDateTime timeStamp;
    private String correlationId;

    public EsbLogEntry(String svId, ZonedDateTime timeStamp, String host, String verb, String path, String correlationId) {
        this.svId = svId;
    ...
    public static Function<String, EsbLogEntry> mapToLogEntry = (line) -> {
        String[] p = line.split("\t");
        String dateTime= p[1].substring(1,p[1].length()-1);
        return new EsbLogEntry(p[0], ZonedDateTime.parse(dateTime), p[2], p[3], p[4], p[5]);
    };
